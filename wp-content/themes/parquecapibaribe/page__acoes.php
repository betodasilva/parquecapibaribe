...
<section id="<?php echo bdq_hash_slug(get_permalink());?>">
  ...
  <div class="row">
    <div class="col-xs-8 col-sm-8 col-md-12">
      ...
      <p>
        ...
        Interessantiss quisso pudia ce receita de bolis, mais bolis eu num gostis.LoreMussum ipsum cacilds, vidis litro abertis. 
        Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. 
      </p>
    </div>
  </div>
  <div class="row">
    <div class="col-xs-8 col-sm-3 col-md-6">
      <div class="img-wrapper">
        <h3>Ribe</h3>
        <h4>outra otima legenda</h4>
          <img class="img-responsive" src="assets/img/slide2.jpg" alt="Primeiro Slide">
        <p>
          LoreMussum ipsum cacilds, vidis litro abertis. 
          Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. 
          Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, 
  ...
  <div class="col-xs-8 col-sm-3 col-md-6">
    <div class="img-wrapper">
      <h3>Provocações Urbanas</h3>
      <h4>outra otima legenda</h4>
        <img class="img-responsive" src="assets/img/slide3.jpg" alt="Primeiro Slide">
      <p>
        LoreMussum ipsum cacilds, vidis litro abertis. 
        Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. 
        Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, 
